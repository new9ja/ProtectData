...
public class ServiceExternal extends IntentService {
    ...
    private static final String ACTION_DOWNLOAD_HOSTS_FILE = "com.baconpoints.procdata.DOWNLOAD_HOSTS_FILE";

    // am startservice -a com.baconpoints.procdata.DOWNLOAD_HOSTS_FILE
