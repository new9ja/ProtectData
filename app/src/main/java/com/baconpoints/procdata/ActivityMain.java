...
public class ActivityMain extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String ACTION_RULES_CHANGED = "com.baconpoints.procdata.ACTION_RULES_CHANGED";
    public static final String ACTION_QUEUE_CHANGED = "com.baconpoints.procdata.ACTION_QUEUE_CHANGED";
    ...
    private static Intent getIntentPro(Context context) {
        if (Util.isPlayStoreInstall(context))
            ...
            intent.setData(Uri.parse("https://protectdatang.blogspot.com/p/contact-us.html"));
            return intent;
        }
    }
    ...
    private static Intent getIntentApps(Context context) {
        return new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/dev?id=7480257428287575756"));
    }
    ...
    private static Intent getIntentSupport() {
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setData(Uri.parse("https://protectdatang.blogspot.com/2020/09/protectdata-faqs.html"));
        return intent;
    }
